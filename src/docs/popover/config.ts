...
const apiReferenceConfig = {
  data: [
    { name: 'dismissable',   type: 'boolean', default: 'true',  description: 'When true, clicking outside the popover will close it.' },
    { name: 'showCloseIcon', type: 'boolean', default: 'false', description: 'When true, renders a × button in the top-right corner of the popover.' },
